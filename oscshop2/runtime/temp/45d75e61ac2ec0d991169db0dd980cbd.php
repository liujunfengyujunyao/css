<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"./oscshop/admin\view\ad\ad_edit.html";i:1560070611;s:57:"D:\WWW\meiyi\oscshop2\oscshop\admin\view\public\base.html";i:1559881380;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<div class="col-xs-12">	
		...
		<div class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<div class="clearfix">
						<input name="url" class="col-xs-10 col-sm-5"  value="<?php echo (isset($cat['url']) && ($cat['url'] !== '')?$cat['url']:''); ?>" type="text">
					</div>
				</div>
			</div>
				...
				<div class="col-sm-5">
					<div class="clearfix">
						<select name="pid">
									...
									<option value="<?php echo $c['module_id']; ?>"><?php echo $c['name']; ?></option>
									<?php endforeach; endif; else: echo "" ;endif; ?>
...
<script>
var back_index="<?php echo url('ad/ad_index'); ?>";
