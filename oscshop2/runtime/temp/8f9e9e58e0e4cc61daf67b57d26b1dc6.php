<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./themes/default/member/account\profile.html";i:1547203759;s:81:"D:\BaiduNetdiskDownload\oscshop\oscshop2\themes\default\member\public\member.html";i:1547203759;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
			...
			<div class="col-sm-10">
				 <div id="thumb">
		                  <a href="#" id="thumb-icon" data-toggle="image" class="img-thumbnail">
		                  	<?php if($user['userpic']): ?>
		                  		<img src="/<?php echo resize($user['userpic'],100,100); ?>" />
		                  	<?php else: ?>
